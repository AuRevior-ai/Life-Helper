...
test("admin category and service edit pages provide minimal create and update forms", () => {
  const categoryListJs = read(
    "miniprogram/pages/admin/category-list/category-list.js",
  );
  const categoryEditJs = read(
    "miniprogram/pages/admin/category-edit/category-edit.js",
  );
  const categoryEditWxml = read(
    "miniprogram/pages/admin/category-edit/category-edit.wxml",
  );
  const serviceListJs = read(
    "miniprogram/pages/admin/service-list/service-list.js",
  );
  const serviceEditJs = read(
    "miniprogram/pages/admin/service-edit/service-edit.js",
  );
  const serviceEditWxml = read(
    "miniprogram/pages/admin/service-edit/service-edit.wxml",
  );
...
test("cloud function wx-server-sdk dependencies are pinned", () => {
  const packageFiles = fs
    ...
    .map((entry) =>
      path.join(rootDir, "cloudfunctions", entry.name, "package.json"),
    )
