...
test('admin qualification and deposit pages handle missing collections without raw cloud database errors', () => {
  const qualificationJs = read('miniprogram/pages/admin/qualification-review/qualification-review.js')
  const qualificationWxml = read('miniprogram/pages/admin/qualification-review/qualification-review.wxml')
  const depositJs = read('miniprogram/pages/admin/deposit-review/deposit-review.js')
  const depositWxml = read('miniprogram/pages/admin/deposit-review/deposit-review.wxml')
