...
const ENTRY_GROUPS = Object.freeze([
  ...
  },
  {
    ...
    entries: [
      ...
      {
        label: "师傅收益",
        url: "/pages/admin/worker-earning-list/worker-earning-list",
      },
      {
        label: "会员方案",
        url: "/pages/admin/member-plan-list/member-plan-list",
      },
      {
        label: "优惠券管理",
  ...
  },
  {
    ...
    entries: [
      ...
      {
        label: "差评申诉",
        url: "/pages/admin/review-appeal-list/review-appeal-list",
      },
    ],
  },
]);
...
Page({
  data: {
    ...
    entryGroups: ENTRY_GROUPS.map((group) => ({
      ...group,
