...
const QUALIFICATION_STATUS_TEXT = Object.freeze({
  [QUALIFICATION_STATUS.NOT_SUBMITTED]: "未提交",
  [QUALIFICATION_STATUS.DRAFT]: "草稿",
  [QUALIFICATION_STATUS.PENDING_REVIEW]: "待审核",
  [QUALIFICATION_STATUS.APPROVED]: "已通过",
  [QUALIFICATION_STATUS.REJECTED]: "已驳回",
  [QUALIFICATION_STATUS.NEED_SUPPLEMENT]: "需补充材料",
  [QUALIFICATION_STATUS.EXPIRED]: "已过期",
});
...
const DEPOSIT_STATUS_TEXT = Object.freeze({
  [DEPOSIT_STATUS.NOT_REQUIRED]: "暂不需要",
  [DEPOSIT_STATUS.UNPAID]: "未缴纳",
  [DEPOSIT_STATUS.MOCK_PAYING]: "模拟缴纳中",
  [DEPOSIT_STATUS.MOCK_PAID]: "已模拟缴纳",
  [DEPOSIT_STATUS.FROZEN]: "已冻结",
  [DEPOSIT_STATUS.REFUND_PENDING]: "退还申请中",
  [DEPOSIT_STATUS.MOCK_REFUNDED]: "已模拟退还",
  [DEPOSIT_STATUS.REFUND_REJECTED]: "退还驳回",
});
...
const RISK_LEVEL_TEXT = Object.freeze({
  [RISK_LEVEL.LOW]: "低风险",
  [RISK_LEVEL.MEDIUM]: "中风险",
  [RISK_LEVEL.HIGH]: "高风险",
  [RISK_LEVEL.BLOCKED]: "限制入驻",
});
...
const ONBOARDING_STATUS_TEXT = Object.freeze({
  [ONBOARDING_STATUS.INCOMPLETE]: "未完成",
  [ONBOARDING_STATUS.QUALIFICATION_WAIT]: "资质待审核",
  [ONBOARDING_STATUS.DEPOSIT_WAIT]: "保证金待处理",
  [ONBOARDING_STATUS.RISK_REVIEW]: "风控复核中",
  [ONBOARDING_STATUS.ACTIVE]: "可正常经营",
  [ONBOARDING_STATUS.LIMITED]: "受限经营",
  [ONBOARDING_STATUS.BLOCKED]: "禁止经营",
});
...
const SERVICE_RANGE_MODE_TEXT = Object.freeze({
  [SERVICE_RANGE_MODE.ADMIN_AREA]: "行政区服务范围",
  [SERVICE_RANGE_MODE.RADIUS]: "半径服务范围",
});
