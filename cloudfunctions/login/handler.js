...
function compactProfile(event = {}) {
  ...
  const nickname = profile.nickname || profile.nickName || event.nickname || event.nickName
  const avatar = profile.avatar || profile.avatarUrl || event.avatar || event.avatarUrl
